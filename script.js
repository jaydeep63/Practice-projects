...
function handleCellClick(event) {
  ...
  // Skip duplicate clicks (within 500ms of a touch)
  if (event.type === 'click' && isTouchDevice && now - lastInputTime < 500) {
    return;
  }
  
  // Prevent rapid successive inputs
...
cells.forEach((cell) => {
  cell.addEventListener('touchstart', handleCellClick, { passive: false, capture: true });
...
resetButton.addEventListener('touchstart', handleResetClick, { passive: false, capture: true });
